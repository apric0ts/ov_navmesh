...
class NavmeshPanel:
    def __init__(self, settings_panel):
        ...
        print("Navmesh Panel started")
        
        self._window = ui.Window("Navmesh", width=300, height=300, position_x = 1500, position_y = 100)
        ...
        with self._window.frame:
            with ui.VStack():
                ...
                def build_navmesh():
                    # build the navmesh
                    self.navmesh.build_navmesh(settings_panel.custom_settings)
                    print(settings_panel.custom_settings["cellSize"])
